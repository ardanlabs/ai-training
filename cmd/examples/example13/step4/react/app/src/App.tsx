              ...
              <div className="content">
                ...
                {msg.toolCall && (
                  ...
                  >
                    ...
                    <br />
                    ToolID[{msg.toolCall.id}]: {msg.toolCall.name}(
                ...
                {msg.usage && (
                  ...
                  >
                    Input: {msg.usage.input_tokens} | Output:{" "}
                    {msg.usage.output_tokens} | Speed:{" "}
                    {msg.usage.tokens_per_second.toFixed(2)} t/s
                  </div>
                )}
              </div>
            </div>
