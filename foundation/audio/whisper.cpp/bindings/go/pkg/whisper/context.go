...
//lint:file-ignore ST1000 Incorrect or missing package comment
...
// Get string id of the transcribed language
func (context *context) GetLanguageID(v bool) string {
	if v {
		languageID := context.model.ctx.Whisper_full_lang_id()
		if languageID == -1 {
			return ""
		}
		return whisper.Whisper_lang_str_full(languageID)
	}
	return ""
}
