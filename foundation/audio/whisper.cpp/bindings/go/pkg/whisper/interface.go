...
type Model interface {
	...
	// Initializes the OpenVINO encoder with the given model path, device and cache directory.
	// Bill: Added this to the interface to expose the call.
	InitOpenVINOEncoder(modelPath string, device string, cacheDir string) error
}
...
type Context interface {
	...
	GetLanguageID(v bool) string // Gets language id string
