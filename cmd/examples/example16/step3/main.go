// This example demonstrates Section 3 ("Defense B: Content Isolation
// (<CONTEXT> delimiters)") of cmd/examples/example16/full. Retrieved
// documents are wrapped in <CONTEXT>...</CONTEXT> tags, and a system-role
// instruction tells the model to treat that block as data only — never to
// follow instructions found inside it and never to call tool_browse based
// on its content.
//
// # Running the example:
//
//	$ make ws-ragpipeline-step3
//
...
func run() error {
	...
	// =========================================================================
	// 3) Defense B: Content Isolation (<CONTEXT> delimiters)
	// =========================================================================
